    ...
    <header className="fixed right-0 left-0 top-0 py-4 px-4 bg-black/40 backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-zinc-900 justify-between">
      ...
      <nav className="absolute left-[50%] top-[50%] transform translate-x-[-50%] translate-y-[-50%] hidden md:block">
        <ul className="flex items-center gap-4 list-none">
          ...
          <li className='text-white font-bold'><Link href="#">Buy me a coffee</Link></li>
        </ul>
      </nav>
      <aside className="flex items-center gap-4">
        ...
        >
          <span className="absolute blur-md inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#000_70%,#fff_20%,#BFB78F_10%)]" />
